...
public class ControladorV5 {
    ...
    public ControladorV5(Promotor promotor, ControladorV2 controlador, ControladorV7 controladorv7){
    ...
    class EventoAceptar implements EventHandler<ActionEvent>{
        ...
        public void handle(ActionEvent event) {
            promotor.setCantPedida(Float.parseFloat(vista.getFnombre().getText()));
            vista.getFnombre().clear();
            ControladorV6 controladorv6 = new ControladorV6(promotor, controlador, controladorv7);
            controladorv6.mostrarVista();
        }
